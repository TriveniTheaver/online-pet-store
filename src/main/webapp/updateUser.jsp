...
<style>
    ...
    body { font-family: Arial, sans-serif;color:#f5ebe0; }
   form { width: 300px; 
           margin: auto; 
           padding:20px 40px; 
...
<body>
		<%
			String id=request.getParameter("id"); //give parameter name 
		...
		%>
<!-- catching values passed by manage users from url -->
	...
	<div class="col-6 mx-auto" style="margin-top:1%" >
		<form action="UpdateServlet" method="post">
			...
			<div class="form-group mb-3 row">
				ID: <input type="text" name="id" value="<%=id%>" class="form-control" readonly>
			</div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-2 row">
				Email: <input type="text" name="gmail" value="<%=gmail%>" class="form-control">
			</div>
			...
			<div class="form-group mb-2 row">
				Role: <input type="text" name="role" value="<%=role%>" class="form-control">
			</div>
			
			<div class="form-group mb-2 row">
				Password: <input type="text" name="pw" value="<%=pw%>" class="form-control" readonly>
			</div>
			<br>
			<div class="form-group mb-2 row">
